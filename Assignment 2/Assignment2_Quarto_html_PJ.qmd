...
for (i in 1:5) {
  ...
  # Estimate the model
  model_OLS_2 <- update(model_OLS_1, . ~ . + accommodates + bedrooms + beds + property_type + room_type + num_baths + num_shared_baths + is_half_bath + num_private_baths + amenities, data = train)
