...
unified <- unify(model_RF_optm, hold_out_Mar)


## Produce SHAP values
treeshap_all <- treeshap(unified, hold_out_Mar)

## Create shapviz object
shp_viz <- shapviz(treeshap_all, X = hold_out_Mar)
