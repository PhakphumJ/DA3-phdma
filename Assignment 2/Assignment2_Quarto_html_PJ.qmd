...
# OLS
RMSE_OLS_small <- RMSE(hold_out_Mar %>% filter(accommodates <= 3)$price, hold_out_Mar %>% filter(accommodates <= 3)$price_pred_ols)

RMSE_OLS_large <- RMSE(hold_out_Mar %>% filter(accommodates > 3)$price, hold_out_Mar %>% filter(accommodates > 3)$price_pred_ols)

# RF
RMSE_RF_small <- RMSE(hold_out_Mar %>% filter(accommodates <= 3)$price, hold_out_Mar %>% filter(accommodates <= 3)$price_pred_RF)

RMSE_RF_large <- RMSE(hold_out_Mar %>% filter(accommodates > 3)$price, hold_out_Mar %>% filter(accommodates > 3)$price_pred_RF)

# Bagging
RMSE_bag_small <- RMSE(hold_out_Mar %>% filter(accommodates <= 3)$price, hold_out_Mar %>% filter(accommodates <= 3)$price_pred_bag)

RMSE_bag_large <- RMSE(hold_out_Mar %>% filter(accommodates > 3)$price, hold_out_Mar %>% filter(accommodates > 3)$price_pred_bag)
