...
I convert the price from THB to GBP using the exchange rate on the date that data is scarped. This is to improve comparability with the case study and improve computational efficiency.

The exchange rates are 0.0238 GBP/THB on 29-03-2023 and 0.0223	GBP/THB on 22-09-2023 [^1].

[^1]: The data used is the opening exchange rate from Yahoo Finance: https://finance.yahoo.com/quote/THBGBP%3DX/history?p=THBGBP%3DX

```{r}
## Converting price to GBP
...
## Converting price to GBP
Data_Sept$price <- Data_Sept$price * 0.0223
