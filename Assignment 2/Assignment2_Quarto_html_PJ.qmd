...
## hold-out set will only consists of apartments. Split 10% of apartments into hold-out set.
...
## Correcting the missing columns in the holdout set.
hold_out_Mar$'property_type_Shared room in serviced apartment' <- 0
```
