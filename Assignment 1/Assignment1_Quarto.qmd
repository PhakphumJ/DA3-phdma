...
correlations = cor(WorkingData[,-c(1,5)])
...
&nbsp;\ 
&nbsp;\
which means adding working hours, race, and class of worker to **Model 1**\

**Model 3:** **Model 2** + *(Minwage, ind02)*\
&nbsp;\
meaning that I accounted for variation in minimum wages among states and characteristics of each industry.\

**Model 4:** **Model 3** + *(ownchild, male)*\
&nbsp;\ adding the variables with least correlations with *earnhr* to the model. \
