...
# Remove the column "ind"
X_Lasso <- X_Lasso[, colnames(X_Lasso)!= "ind"]
...
set.seed(20231210)
# Fit the model
lasso_fit <- cv.glmnet(X_Lasso, Y_Lasso, family = "binomial", alpha = 1, nfolds = 5, standardize = TRUE)
...
Lasso_optimal <- glmnet(X_Lasso, Y_Lasso, family = "binomial", alpha = 1, lambda = lambda_optimal, standardize = TRUE)
```
...
model_RF <- train(fast_growing ~ ., data = Data_2012, method = "rf", trControl = control, tuneGrid = grid, ntree = 150)
```
