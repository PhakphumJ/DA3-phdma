...
logit_lasso_model <- train(formula(paste0("fast_growing ~", paste0(Lasso_vars, collapse = " + "))),
    ...
    trControl = control,
    tuneGrid = grid,
    na.action=na.exclude,  metric = "RMSE")
...
MAE_lasso <- logit_lasso_model$resample$MAE

## RMSE
RMSE_lasso <- sqrt(mean(MAE_lasso))
```

We will retun back and converting fast_growing to a factor variable to be able to get AUC.
